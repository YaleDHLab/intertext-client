  ...
  return (
    <div className='advanced-filter-column flex-1' ref={ref}>
      ...
      <div className='advanced-filter-footer justify-end row align-center'>
        <div className='advanced-filter-clear' onClick={clear}>Clear</div>
        <button className={buttonClass} onClick={search}>Apply</button>
      </div>
    </div>
  );
}
...
const AdvancedFilterInput = props => {
  return (
    <input type='text' onChange={e => props.onChange(props, e)} />
  )
}
